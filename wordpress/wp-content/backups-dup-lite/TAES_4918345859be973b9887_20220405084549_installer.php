...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'TAES_4918345859be973b9887_20220405084549_archive.zip';
	const ARCHIVE_SIZE		 = '69780851';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '4918345-05084549';
    const SECONDARY_PACKAGE_HASH = '5ff73c8-05084549';
	const VERSION			 = '1.4.4';
