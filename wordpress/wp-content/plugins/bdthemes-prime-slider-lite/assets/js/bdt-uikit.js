/*! bdtUIkit 3.13.1 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */
...
(function (global, factory) {
    ...
    */
    ...
    var drop = {
      ...
      connected() {
        this.clsPos = this.clsDrop = this.$props.clsDrop || "bdt-" + this.$options.name;
    ...
    const navItem = '.bdt-navbar-nav > li > a, .bdt-navbar-item, .bdt-navbar-toggle';
      ...
      update: [
      {
        read() {
          for (const el of this.elements) {
            if (!el[stateKey]) {
              el[stateKey] = { cls: data(el, 'bdt-scrollspy-class') || this.cls };
            }
