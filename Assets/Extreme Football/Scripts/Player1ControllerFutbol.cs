...
public class Player1ControllerFutbol : MonoBehaviour
{
    bool canJump2 = false;
    ...
    void Update()
    {
        ...
        //DOBLE SALTO
        if(!VerificarSuelo.isGrounded && Input.GetKeyDown("w") && canJump2)
        {
            rb2d.velocity = new Vector2(rb2d.velocity.x, jumpSpeed);
            canJump2 = false;
        }

        else if (Input.GetKeyDown("w") && VerificarSuelo.isGrounded)
        {
            rb2d.velocity = new Vector2(rb2d.velocity.x, jumpSpeed);
            canJump2 = true;
        }
