...
public class Player3Controller : MonoBehaviour
{
    ...
    public Player4Controller player4;
    ...
    void Start()
    {
        ...
        gameObject.GetComponent<Transform>().position = new Vector3(-480, -50, 0);
    ...
    void Update()
    {
        if (gameObject.transform.position.x < 750)
        {
            ...
            {
                if ((Input.GetKey(KeyCode.D) || push) && veces == 0)
                {
                    push = false;
        ...
        else
        {
            ...
            player4.gameObject.GetComponent<Transform>().position = new Vector3(-50, -350, 0);
