...
public class Login : MonoBehaviour
{
    ...
    private string juegoSeleccionado = "juego1"; //la app móvil espera "juego1" o "juego2" o "juego3" para saber que controles mostrar
            ...
            using (var command = connection.CreateCommand())
            {
                ...
                /*while (true)
                {
                    ...
                    using (reader = command.ExecuteReader())
                    {
                        ...
                        {
                            UnityEngine.Debug.Log("Empezaré a leer los usuarios");
