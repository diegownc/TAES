...
public class Jelly1Controller : MonoBehaviour
{
    public FondoController fondo;
    public NotaController nota;
    public MarcaController marca;
    ...
    void Start()
    {
        ...
        marca = FindObjectOfType<MarcaController>();
        ...
        gameObject.GetComponent<Transform>().position = new Vector3(-480, 200, 0);

        udp = new UdpClient(8056);
    ...
    void Update()
    {
        ...
        if (gameObject.transform.position.x < 550)
        {
            ...
            {
                if ((Input.GetKey(KeyCode.Space) || push) && veces == 0)
                {
                    push = false;
        ...
        else
        {
            if (fin)
            {
                ...
                gameObject.GetComponent<Transform>().position = new Vector3(0, 160, 0);
                ...
                if (segundo == 2)
                {
                    player2.gameObject.GetComponent<Transform>().position = new Vector3(-340, -40, 0);
                }
                if (segundo == 3)
                {
